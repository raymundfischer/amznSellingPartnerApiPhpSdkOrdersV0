# amznSellingPartnerApiPhpSdk\OrdersV0\OrdersV0Api
...
# **getOrder**
> \amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderResponse getOrder($order_id)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderResponse**](../Model/GetOrderResponse.md)
...
# **getOrderAddress**
> \amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderAddressResponse getOrderAddress($order_id)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderAddressResponse**](../Model/GetOrderAddressResponse.md)
...
# **getOrderBuyerInfo**
> \amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderBuyerInfoResponse getOrderBuyerInfo($order_id)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderBuyerInfoResponse**](../Model/GetOrderBuyerInfoResponse.md)
...
# **getOrderItems**
> \amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderItemsResponse getOrderItems($order_id, $next_token)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderItemsResponse**](../Model/GetOrderItemsResponse.md)
...
> \amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderItemsBuyerInfoResponse getOrderItemsBuyerInfo($order_id, $next_token)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrderItemsBuyerInfoResponse**](../Model/GetOrderItemsBuyerInfoResponse.md)
...
[**\amznSellingPartnerApiPhpSdk\OrdersV0\Model\GetOrdersResponse**](../Model/GetOrdersResponse.md)
